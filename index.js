(function (root, factory) {
    ...
    function registerHandleId(id, handle){
        if(!registry[id]){
            registry[id] = [];
        }
    ...
    function EventTree(options){ this.constructor(options);}
    ...
    EventTree.prototype = {
        ...
        on: function(name, callback, context, handleId){
            ...
            if(handleId){
                registerHandleId(handleId, handle);
            }
